...
import { mutations as productMutations, queries as productQueries } from '../graphql';
import {
  IProduct, IProductDoc, ProductAddMutationResponse, ProductCategoriesQueryResponse,
